...
4. [RDD vs Dataframe vs Dataset](https://www.databricks.com/blog/2016/07/14/a-tale-of-three-apache-spark-apis-rdds-dataframes-and-datasets.html)
5. [Spark SQL: API Doc (Scala)](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/sql/index.html)
6. [Reading Command-Line Arguments in Scala](https://www.baeldung.com/scala/read-command-line-arguments)
7. [Spark Scala: Operations on One Column](https://haya-toumy.gitbook.io/spark-notes/spark-scala/spark-scala/operations-on-one-column)
8. [Spark SQL UDFs](https://jaceklaskowski.gitbooks.io/mastering-spark-sql/content/spark-sql-udfs.html)
9. [Sum a list of tuples by foldLeft](https://stackoverflow.com/questions/30154736/how-to-sum-a-list-of-tuples)
